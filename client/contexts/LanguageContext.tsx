...
const translations = {
  ...
  ar: {
    ...
    "customers.subtitle": "إ��ارة قاعدة بيانات العملاء",
    ...
    "message.success": "تمت العملية ب��جاح",
    ...
    "checkout.backupRestore": "النسخ ��لاحتياطي والاستعادة",
    ...
    "categories.deleteMessage":
      "هل أنت متأكد من حذف هذا ال��صنيف؟ هذا الإجراء لا يمكن التراجع عنه.",
    ...
    "settings.saveSuccess": "تم حفظ الإعدادات بن��اح!",
    "settings.saveError": "فشل في حفظ الإعدادات. يرجى المحاولة مرة أخرى.",
    "settings.resetConfirm":
      "هل أنت متأكد من إعادة تعيي�� جميع الإعدادات للقيم الافتراضية؟",
    ...
    "settings.pickupAddress": "عنوا�� الاستلام",
    ...
    "settings.importSettings": "استيراد الإعداد��ت",
    "settings.exportDescription": "تحميل إعداداتك الحالية كملف نسخ احتياطي",
    "settings.importDescription": "رفع ملف إعدادات مُصدّر مسبقا��",
    ...
    "settings.enableAnalytics": "التحليل��ت",
