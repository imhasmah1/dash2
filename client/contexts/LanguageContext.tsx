...
const translations = {
  ...
  ar: {
    ...
    "products.productName": "اسم ا��منتج",
    ...
    "revenue.ordersCount": "ع��د الطلبات",
    ...
    "message.customerUpdated": "تم تح��يث العميل بنجاح",
    ...
    "checkout.noCreditCard": "لا حاجة ��بطاقة ائتمان - الدفع عند التسليم فقط!",
    ...
    "analytics.totalProducts": "إجمال�� المنتجات",
    ...
    "settings.displayOrderItems": "عرض عنا��ر الطلب",
    ...
    "settings.operationalSettings": "الإعدادات ��لتشغيلية",
