...
const translations = {
  ...
  ar: {
    ...
    "customers.customerBlock": "رق�� المجمع",
    ...
    "settings.displayOrderItems": "عر�� عناصر الطلب",
    ...
    "settings.newPassword": "كلمة ��لمرور الجديدة",
    ...
    "settings.adminPasswordHint": "قم بتغيير كلم�� المرور للوصول إلى لوحة التحكم",
